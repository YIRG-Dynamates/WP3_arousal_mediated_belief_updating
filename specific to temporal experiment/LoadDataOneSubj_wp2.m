function [trials_cell_all_blocks,block_settings] = LoadDataOneSubj_wp2(save_path,subj_str)
...
fields = {'x','v','cp','d','mu_exp','sd_exp','space_limits'};
...
for j=1:num_blocks
    ...
    %Convert the data in trials_cell so that it can be used in the model
    trials_cell = convertTempoTrialsCellForModel(trials_cell);
