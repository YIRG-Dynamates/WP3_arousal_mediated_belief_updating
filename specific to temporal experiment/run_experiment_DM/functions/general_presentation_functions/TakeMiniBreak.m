...
while ~timeExceededBool && ~EscapePressedBool
    ...
    %Draw text
    Screen('DrawText',P.win, textAbove, coordsXYAboveText(1), coordsXYAboveText(2), P.draw_color);
    Screen('DrawText',P.win, textBelow, coordsXYBelowText(1), coordsXYBelowText(2), P.draw_color);
...
function quote = GiveMeAQuote()
    ...
    MotivationalQuotes = {'Keep up the good work';
                          'Do not give up';
                          ...
                          'The one who is swimming against the stream knows the strength of it';
