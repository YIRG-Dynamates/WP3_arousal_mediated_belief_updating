function dir_exp_fitfun_3(subj_nr)
...
save(fullfile(save_path,[subj_ID '_BdCPfitResults_3.mat']),'subj_ID','BdCPfitResults','-v7.3');

%Report computation time in command window
fprintf('Finished fit 3 and saved data for subject %i (%s),\nElapsed time (days hours:minutes:seconds) %s \n', ... 
