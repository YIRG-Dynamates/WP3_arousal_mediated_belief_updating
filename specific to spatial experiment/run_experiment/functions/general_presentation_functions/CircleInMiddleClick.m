...
while ~continueBool
    ...
    DrawFormattedText(P.win, myTextCentre, round(D.win_center_x-boundsTextCentre(3)/2), round(D.win_center_y-boundsTextCentre(4)/2), P.draw_color);     %draw text in startButton
    ...
    if within_startButton_bool
        ...
        DrawFormattedText(P.win, myTextCentre, round(D.win_center_x-boundsTextCentre(3)/2), round(D.win_center_y-boundsTextCentre(4)/2), 0);%draw black text in startButton
    else
