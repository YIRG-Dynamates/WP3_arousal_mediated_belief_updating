...
dyn_path = 'C:\Users\rfleischmann\Documents\GitHub\dynamates'

%Add the model and its sub-functions to the path
model_path = fullfile(dyn_path, 'modelling', 'krishnamurthy_based', 'replication','pupillometry','pupil_model');
addpath(genpath(model_path));    

%% Generate all stimuli for the full experiment

%Use default set of trials 
gen_trials_path = fullfile(dyn_path, 'Experiment', 'krishnamurthy_replication', 'run_experiment', 'functions', 'genTrials_SAC');
